          ...
          <div class="clearfix">
            ...
            <div class="col-md-4">
              ...
              <div class="clearfix">
                ...
                <span class="xvalue"><?=numbers($member->kills)?></span>
              </div>
              <div class="clearfix">
                <span class="icon icon-deaths"></span>
                <span class="xlabel"><?=translate('deaths')?></span>
                <span class="xvalue"><?=numbers($member->deaths)?></span>
              </div>
              <div class="clearfix">
                <span class="icon icon-win"></span>
                <span class="xlabel"><?=translate('win')?></span>
                <span class="xvalue"><?=numbers($member->wins)?></span>
              </div>
              <div class="clearfix">
                <span class="icon icon-played"></span>
                <span class="xlabel"><?=translate('played')?></span>
                <span class="xvalue"><?=numbers($member->wins+$member->losses)?></span>
              </div>
              <div class="clearfix">
